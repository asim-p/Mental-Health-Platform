...
import { api, AvailabilitySlot } from "../services/api";
...
export function TherapistAvailability() {
    ...
    const fetchAvailability = async () => {
      try {
        ...
        if (response.success && response.data) {
          // The backend returns availability in the profile
  ...
  const handleUpdateSlot = (index: number, updates: Partial<AvailabilitySlot>) => {
