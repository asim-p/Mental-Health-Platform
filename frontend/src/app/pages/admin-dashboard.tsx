...
import { api, User, Appointment } from '../services/api';

interface TherapistWithProfile extends User {
  profile?: {
...
export function AdminDashboard() {
  ...
  const [pendingTherapists, setPendingTherapists] = useState<TherapistWithProfile[]>([]);
  const [verifiedTherapists, setVerifiedTherapists] = useState<TherapistWithProfile[]>([]);
    ...
    const fetchData = async () => {
      try {
        ...
        if (therapistsRes.success && therapistsRes.data) {
          const allTherapists = therapistsRes.data as unknown as TherapistWithProfile[];
