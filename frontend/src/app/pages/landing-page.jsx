          ...
          <div className="bg-primary rounded-3xl p-8 md:p-16 flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left relative overflow-hidden">
            <div className="relative z-10 max-w-2xl">
              <h2 className="text-3xl md:text-4xl font-black text-primary-foreground mb-4">
                ...
                Join our Mental Health Platform to expand your practice and help people across Nepal access the care they need.
              <Link to="/register">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div className="col-span-1 md:col-span-1">
              <div className="flex items-center gap-2 mb-4 text-primary">
                ...
                <span className="text-xl font-bold">MHP</span>
              </div>
            ...
            <div>
              ...
              <ul className="flex flex-col gap-2 text-sm text-muted-foreground">
                <li className="flex items-center gap-2">support@mentalhealthplatform.edu.np</li>
